      ...
      return (
        <footer className="footer">
          ...
          <div className="credit">
            <p>Wallpaper designs by <a href="https://www.kategolding.ca/" target="_blank">Kate Golding</a>. Film photography by <a href="https://instagram.com/bea.utifulloser" target="_blank">Ciarán Bailey</a>. <span className="line-break"><br/></span>Website designed and developed by <a href="https://danateagle.com" target="_blank">Dana Teagle</a>.</p>
          </div>
